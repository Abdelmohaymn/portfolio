            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final double carouselHeight = isMobile
                    ? math.max(460.0, viewportHeight * 0.65)
                    : isTablet
                        ? math.max(560.0, viewportHeight * 0.65)
            ...
            Row(
              ...
              children: List.generate(
                ...
                (index) => Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: _currentPage == index ? AppColors.gradientStart : AppColors.withAlpha(Colors.white, 0.2),
                  ),
                ),
              ),
            ),
